...
export function createMcpHandler(dispatch) {
  ...
  const REF_SUPPORTING = new Set([
    ...
    "screenshot", "check", "uncheck", "focus",
    "dblclick", "highlight", "get", "is", "upload",
  ]);
  ...
  { name: "screenshot",
    description: "Take a screenshot of the current tab. Returns a JPEG image content block. Prefer extract/execute for text. On anti-bot sites use stealth=true.",
